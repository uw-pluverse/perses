...
class OrigFormatPrinter private constructor(val keepBlankLines: Boolean) :
  ...
  companion object {
    val ORIG_FORMAT = OrigFormatPrinter(keepBlankLines = true)
    val COMPACT_ORIG_FORMAT = OrigFormatPrinter(keepBlankLines = false)
  }
}
