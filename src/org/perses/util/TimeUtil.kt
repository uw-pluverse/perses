...
object TimeUtil {
  ...
  fun formatDateForFileName(datetime: LocalDateTime): String =
    DATE_FORMAT_FOR_FILE_NAME.format(datetime)

  @JvmStatic
  fun formatDateForFileName(epochMillis: Long): String =
    formatDateForFileName(converToLocalDateTime(epochMillis, ZoneId.systemDefault()))

  @JvmStatic
  @VisibleForTesting
  fun converToLocalDateTime(
    epochMillis: Long,
    zone: ZoneId,
  ): LocalDateTime {
  ...
  fun formatDateForDisplay(epochMillis: Long): String =
    formatDateForDisplay(converToLocalDateTime(epochMillis, ZoneId.systemDefault()))

  @JvmStatic
  fun formatDateForDisplay(datetime: LocalDateTime): String =
    DATE_FORMAT_FOR_DISPLAY.format(datetime)
