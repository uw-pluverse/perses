...
public interface GoParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link GoParser#realStatement}.
	 * @param ctx the parse tree
	 */
	void enterRealStatement(GoParser.RealStatementContext ctx);
	/**
	 * Exit a parse tree produced by {@link GoParser#realStatement}.
	 * @param ctx the parse tree
	 */
	void exitRealStatement(GoParser.RealStatementContext ctx);
	/**
	 * Enter a parse tree produced by {@link GoParser#realSimpleStmt}.
	 * @param ctx the parse tree
	 */
	void enterRealSimpleStmt(GoParser.RealSimpleStmtContext ctx);
	/**
	 * Exit a parse tree produced by {@link GoParser#realSimpleStmt}.
	 * @param ctx the parse tree
	 */
	void exitRealSimpleStmt(GoParser.RealSimpleStmtContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link GoParser#unaryExpr}.
	 * @param ctx the parse tree
	 */
	void enterUnaryExpr(GoParser.UnaryExprContext ctx);
	/**
	 * Exit a parse tree produced by {@link GoParser#unaryExpr}.
	 * @param ctx the parse tree
	 */
	void exitUnaryExpr(GoParser.UnaryExprContext ctx);
	/**
