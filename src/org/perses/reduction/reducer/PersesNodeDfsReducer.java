...
public class PersesNodeDfsReducer extends AbstractPersesNodeReducer {

  public static final String NAME = "perses_node_with_dfs_delta";
  public static final ReducerAnnotation META =
      new ReducerAnnotation() {
        ...
        public AbstractReducer create(ReducerContext reducerContext) {
          return new PersesNodeDfsReducer(this, reducerContext);
        }
      };

  private final AbstractDeltaDebugger deltaDebugger;

  protected PersesNodeDfsReducer(
      ReducerAnnotation reducerAnnotation, ReducerContext reducerContext) {
    super(reducerAnnotation, reducerContext);
    deltaDebugger =
        reducerContext.getConfiguration().getUseRealDeltaDebugger()
            ? new DeltaDebugger(
