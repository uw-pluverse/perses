...
public final class PersesNodePrioritizedBfsReducer extends PersesNodeBfsReducer {

  public static final String NAME = "perses_node_priority_with_bfs_delta";
  public static final ReducerAnnotation META =
      new ReducerAnnotation() {
        ...
        public AbstractReducer create(ReducerContext reducerContext) {
          return new PersesNodePrioritizedBfsReducer(reducerContext);
        }
      };

  protected PersesNodePrioritizedBfsReducer(ReducerContext reducerContext) {
