...
abstract class RccProgramEncoding private constructor(
  ...
  companion object {
    ...
    fun createCompressedEncoding(
      ...
      return object : RccProgramEncoding(
        baseProgram,
    ...
    fun createIntervalEncoding(
      ...
      check(intervals.size % 2 == 0)
      return object : RccProgramEncoding(baseProgram, intervals.toIntArray(), tokenCount) {
        override val intervalsFromEncoding: IntArray
          get() = encoding
      }
    }
