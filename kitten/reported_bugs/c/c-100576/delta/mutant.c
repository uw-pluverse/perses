...
extern int
q ( const void * , const void * , size_t ) ; struct Si16_x { int16_t n , a [ ] ; } ; const struct Si16_x si16_4 = { 0x1112 , { 0x2122 , 0x3132 , 0x4142 } } ; const char si16_4_rep [ ] = { 0x12 , 0x11 , 0x22 , 0x21 , 0x32 , 0x31 , 0x42 , 0x41 } ; void eq_si16_x ( void ) { int n = 0 , b = sizeof si16_4_rep ; const char * p = ( const char * ) & si16_4 , * q = si16_4_rep ; n += memcmp ( p , q , b ) ; n += memcmp ( p + 1 , q + 1 , b - 1 ) ; n += memcmp ( p + 2 , q + 2 , b - 2 ) ; n += memcmp ( p + 3 , q + 3 , b - 3 ) ; n += memcmp ( p + 4 , q + 4 , b - 4 ) ;
