...
void ( * p ) ( int ) = baz ;
void ( * p2 ) ( int ) = & baz ;
foo = baz ; p = & baz ; } enum { TRUEFACTS = 1 } ; void qux ( int m ) __attribute__ ( ( overloadable , enable_if ( 1 , "" ) , enable_if ( TRUEFACTS , "" ) ) ) ; void qux ( int m ) __attribute__ ( ( overloadable , enable_if ( 1 , "" ) ) ) ; void test4 ( ) { void ( * p ) ( int ) = qux ; void ( * p2 ) ( int ) = & qux ; p = qux ; p = & qux ; } void test5 ( ) { int foo ( char * i ) __attribute__ ( ( enable_if ( 1 , "" ) , overloadable ) ) ;
