...
if ! grep --quiet --fixed-strings "Exception in thread \"main\" java.lang.AssertionError: assertion failed: no member [33mthis[0m.annotation . ==, members = Scope{" "${OUTPUT}" ; then
  exit 1
fi
