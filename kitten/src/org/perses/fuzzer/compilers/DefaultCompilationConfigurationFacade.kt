...
class DefaultCompilationConfigurationFacade(
    ...
    programUnderTest.flagsToTest.forEach {
      result.add(
        CommonCompilationAction(
          compilerCmd = compilerCommand,
          compilerFlags = ImmutableList.copyOf(it.flags),
          versionPrintFlags = ImmutableList.copyOf(programUnderTest.versionFlags.flags),
