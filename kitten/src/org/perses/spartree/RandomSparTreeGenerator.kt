...
class RandomSparTreeGenerator(
  ...
  override fun internalGenerateParserRuleSparTreeNodeWithMaxDepth(
    ...
    while (queue.isNotEmpty()) {
      ...
      while (levelSize-- > 0) {
        ...
        addChildrenAndUpdateQueue(node, ruleBody, queue, depth)
      }
    }
  ...
  private fun chooseAlternative(
    ...
    val index = random.nextInt(filteredAlternatives.size)
    return filteredAlternatives[index]
  }
