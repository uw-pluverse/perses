...
readonly CLANG_TRUNK="clang-trunk-afl"
readonly CLANGPP_TRUNK="clang++-trunk-afl"
...
echo "${CLANG_TRUNK} and ${CLANGPP_TRUNK} are created successfully in ${HOME_USR_BIN}"
