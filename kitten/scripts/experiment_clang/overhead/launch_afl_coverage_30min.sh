...
java -Xmx210G -Xms30G -Djava.library.path=bazel-bin/kitten/src/org/perses/fuzzer/coveragecollector \
  ...
  --coverage-save "${PWD}/kitten/temp_experiment_results/clang_overhead_coverage" \
  --seed-limit 1000
