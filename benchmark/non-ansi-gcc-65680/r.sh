...
TIMEOUTCCOMP=10
CFILE=small.c
CFLAG="-o t -I /usr/local/include/csmith-2.2.0"
...
if 
  clang-7.1.0 -pedantic -Wall -Wsystem-headers -O0 -c $CFILE -I /usr/local/include/csmith-2.2.0 >out.txt 2>&1 &&\
  ...
  gcc-7.1.0 -Wall -Wextra -Wsystem-headers -O0 $CFILE -I /usr/local/include/csmith-2.2.0 >outa.txt 2>&1 &&\
