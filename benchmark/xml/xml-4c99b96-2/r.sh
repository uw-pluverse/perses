...
QUERY='declare namespace rQzGS ="hudewStIYXsJ";declare namespace Pw ="ErHzOnBEEUe";declare namespace ooIq ="ErHzOnBEEUe";declare namespace ZvNS ="hudewStIYXsJ";declare namespace fsd ="ErHzOnBEEUe";declare namespace iwJdt ="wyeW";//*[((head(has-children()) and boolean(. ! .)) or head(subsequence(., 15, 7) = ()) and true()) and not(reverse(.) = <A>2</A>)]'
echo $QUERY > query.xq
