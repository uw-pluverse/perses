...
QUERY='declare namespace HX ="nairSsReKrfzCEJE";declare namespace rctcf ="h";declare namespace b ="dGufqqUootNHfZHi";declare namespace c ="nairSsReKrfzCEJE";declare namespace OzT ="h";declare namespace yt ="GziNeydlJHDRd";declare namespace Tpc ="GDSOpkuTwwKOS";declare namespace p ="OSbhvjxDiTK";//J14[not(head(subsequence(./*//p:A6, 36, 1))/has-children() != true())]'
echo $QUERY > query.xq
