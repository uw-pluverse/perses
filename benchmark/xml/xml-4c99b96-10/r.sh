...
QUERY='declare namespace EG ="Sa";declare namespace ESH ="ghVATpybGo";declare namespace cNJVE ="LHncZEBpIoGdNUG";declare namespace NZ ="CSc";declare namespace TtGOy ="KfOzgNZEyYXDPMPHdlT";declare namespace iB ="xyoOmywJtP";declare namespace kI ="ndTb";declare namespace cYVr ="Sa";//*[boolean(subsequence(head(subsequence(subsequence(.//NZ:X27, 36), 40)), 2, 3)) or head(reverse(has-children(.)) = true())]'
echo $QUERY > query.xq
