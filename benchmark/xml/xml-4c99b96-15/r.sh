...
QUERY='declare namespace xb ="teZMXQY";declare namespace aD ="KuVRduDupTsaur";declare namespace DXc ="KuVRduDupTsaur";declare namespace JKsyS ="KuVRduDupTsaur";declare namespace n ="teZMXQY";//*[not(boolean(./(V6))) and (. ! .)/has-children() ! .]'
echo $QUERY > query.xq
