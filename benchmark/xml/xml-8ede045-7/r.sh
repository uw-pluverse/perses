...
QUERY='declare namespace pfa ="kXTsueAfkCgMkKpwmKZ";declare namespace usn ="RhMgKqEwDou";declare namespace umrQj ="zTpEhiL";declare namespace NlbcE ="kXTsueAfkCgMkKpwmKZ";//pfa:X3[boolean(./preceding::*[not(has-children() and false())]/child::umrQj:K1) and (not(head(C29)/has-children() !=true()) and has-children())]'
echo $QUERY > query.xq
