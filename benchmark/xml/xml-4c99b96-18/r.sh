...
QUERY='declare namespace BK ="ygsbwy";declare namespace eI ="YeUvpWcr";declare namespace y ="ygsbwy";declare namespace Jw ="CeDf";declare namespace B ="YeUvpWcr";declare namespace mxnXZ ="DCYLazMRbuKocpLr";declare namespace dm ="YKHFoFEyePzlEYCFRaf";declare namespace kT ="k";declare namespace roP ="lzleRgYxeNq";//*[boolean(subsequence(./parent::*/preceding-sibling::*, 51, 1)) or (not(reverse(.) = <A>2</A>) and head(boolean(has-children() ! reverse(reverse(.)))))]'
echo $QUERY > query.xq
