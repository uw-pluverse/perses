...
QUERY='declare namespace rM ="OzNLfnGWKENQCb";declare namespace s ="OzNLfnGWKENQCb";declare namespace MP ="OzNLfnGWKENQCb";declare namespace d ="VVYjfHUiwQCsjwKihB";declare namespace HWlv ="OzNLfnGWKENQCb";//*[has-children()]'
echo $QUERY > query.xq
