...
QUERY='declare namespace ghUVy ="DWWIVMEufFVyMXeoZcl";declare namespace dlNva ="u";declare namespace RzxwJ ="u";declare namespace C ="qg";declare namespace Tm ="DWWIVMEufFVyMXeoZcl";declare namespace JEUcC ="E";//*[boolean(string-length(local-name())) and has-children()]'
echo $QUERY > query.xq
