...
QUERY='declare namespace QuD ="zPiHj";declare namespace vEvR ="hHOTFCIVGufVMhbHnP";declare namespace gHNi ="RugwBhBitYMdANbfRk";declare namespace pKSFm ="jENtDJFUhhrsMtJSB";declare namespace TZaSh ="zPiHj";declare namespace zwXw ="USagWsLatd";//zwXw:V31[boolean(max(math:cos(position()))) and not((reverse(.)/@w10 ! not(.)) = false())]'
echo $QUERY > query.xq
