...
QUERY='declare namespace jX ="KMKLtwtXi";declare namespace IB ="Ayd";declare namespace D ="CekXRxDtRB";declare namespace kYV ="Ayd";declare namespace tdi ="QIhRSOkSMoMNGP";declare namespace yh ="IaoEr";declare namespace G ="CekXRxDtRB";declare namespace IFZv ="KMKLtwtXi";//*[has-children() = true()]'
echo $QUERY > query.xq
