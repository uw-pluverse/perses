...
QUERY='declare namespace ejJeV ="ZBusjZwoTpXihhdkgr";declare namespace gvLh ="IUIrGsfuok";declare namespace MtFJ ="KTMvRif";declare namespace W ="IUIrGsfuok";declare namespace rW ="vGRmaX";declare namespace lq ="NmoqWVvvWIwtaggxCog";declare namespace JA ="pmoEPoQYyoN";declare namespace wh ="ZLbIfg";declare namespace aL ="NnioGXHjojlWjT";declare namespace mplf ="KTMvRif";declare namespace Wgb ="ZBusjZwoTpXihhdkgr";//*[(boolean(reverse(tail(tail(.//*)))) or ((node-name() castable as xs:string) and not(boolean(subsequence(., 8, 18))))) and not(has-children() != true())]'
echo $QUERY > query.xq
