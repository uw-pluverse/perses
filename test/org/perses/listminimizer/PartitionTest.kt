...
class PartitionTest {
  ...
  fun testPartitionSizeFull() {
    ...
    list.partitions.single().let {
      assertThat(it).containsExactly(0, 1, 2, 3).inOrder()
    ...
    PartitionList.Builder(baseList)
      ...
      .let { list ->
        list.partitions.first().let {
          assertThat(it).containsExactly(0, 1).inOrder()
