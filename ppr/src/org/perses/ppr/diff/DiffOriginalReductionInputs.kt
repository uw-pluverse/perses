...
/**
 * The reduction inputs shared by the diff-based reducers (list diff and tree diff): a [seedFile]
 * to reduce towards, a [variantFile] that provides the alternative content, and the usual test
 * script and dependency files.
 */
class DiffOriginalReductionInputs(
  ...
  companion object {
    inline fun create(
      ...
      return DiffOriginalReductionInputs(
