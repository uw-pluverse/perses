...
{
  if (((__builtin_isunordered ((x), (y)) || ((x) == (y)))) != ok) abort ();;
  if ((!(__builtin_islessgreater ((x), (y)))) != ok) abort ();;
  if (((__builtin_isunordered ((x), (y)) || ((x) <= (y))) && (__builtin_isunordered ((x), (y)) || ((x) >= (y)))) != ok) abort ();;
}

int ieq (float x, float y, int ok)
{
  if (((!__builtin_isunordered ((x), (y))) && (__builtin_isunordered ((x), (y)) || ((x) == (y)))) != ok) abort ();;
}
...
int iltgt (float x, float y, int ok)
{
  if ((!(__builtin_isunordered ((x), (y)) || ((x) == (y)))) != ok) abort ();;
  if (((__builtin_islessgreater ((x), (y)))) != ok) abort ();;
  if (((!__builtin_isunordered ((x), (y))) && ((__builtin_isunordered ((x), (y)) || ((x) < (y))) || (__builtin_isunordered ((x), (y)) || ((x) > (y))))) != ok) abort ();;
}
