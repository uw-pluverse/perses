...
f5 (char ***bar)
{
  volatile const char ***p9 = (volatile const char ***) bar;
  volatile char * const **p11 = (volatile char * const **) bar;
  volatile char ** const *p13 = (volatile char ** const *) bar;
  volatile const char * const **p15 = (volatile const char * const **) bar;
  volatile const char ** const *p17 = (volatile const char ** const *) bar;
...
f6 (char ***bar)
{
  const char * volatile **p9 = (const char * volatile **) bar;
  char * volatile const **p11 = (char * volatile const **) bar;
  char * volatile * const *p13 = (char * volatile * const *) bar;
  const char * volatile const **p15 = (const char * volatile const **) bar;
  const char * volatile * const *p17 = (const char * volatile * const *) bar;
...
{
  const char ** volatile *p9 = (const char ** volatile *) bar;
  char * const * volatile *p11 = (char * const * volatile *) bar;
  char ** volatile const *p13 = (char ** volatile const *) bar;
  const char * const * volatile *p15 = (const char * const * volatile *) bar;
  const char ** volatile const *p17 = (const char ** volatile const *) bar;
...
f8 (constfn ***bar)
{
  ...
  const constfn ***p9 = (const constfn ***) bar;
  const pintfn ***p10 = (const pintfn ***) bar;
  constfn * const **p11 = (constfn * const **) bar;
  pintfn * const **p12 = (pintfn * const **) bar;
  constfn ** const *p13 = (constfn ** const *) bar;
  pintfn ** const *p14 = (pintfn ** const *) bar;
  const constfn * const **p15 = (const constfn * const **) bar;
  const pintfn * const **p16 = (const pintfn * const **) bar;
  const constfn ** const *p17 = (const constfn ** const *) bar;
  const pintfn ** const *p18 = (const pintfn ** const *) bar;
