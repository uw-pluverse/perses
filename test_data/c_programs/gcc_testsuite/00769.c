...
void testfunc(char* stack)
{
  ...
  { int __x = 9; ; if (validate_memory (&__x, stack + 100, sizeof (int), flat) != 0) abort(); }
  { struct z __x = a; ; if (validate_memory (&__x, stack + 0, sizeof (struct z), flat) != 0) abort(); }
  { double __x = 1.0; ; if (validate_memory (&__x, stack + 32, sizeof (double), flat) != 0) abort(); }
  { struct z __x = b; ; if (validate_memory (&__x, stack + 336, sizeof (struct z), flat) != 0) abort(); }
  { int __x = 4; ; if (validate_memory (&__x, stack + 104, sizeof (int), flat) != 0) abort(); }
  { double __x = 0.5; ; if (validate_memory (&__x, stack + 336 +32, sizeof (double), flat) != 0) abort(); }
