...
double
fn1 (double h, double l)
{
  return h + l;
}
double fn1 (double, double) __attribute__ ((optimize ("no-associative-math")));
...
fn4 (double h, double l)
{
  return h + l;
}
double fn4 (double, double) __attribute__ ((optimize ("O2,no-associative-math")));
