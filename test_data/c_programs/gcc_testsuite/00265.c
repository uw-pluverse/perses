...
void v16qi_vspltish ()
{
  v16qi v = {15,0,15,0,15,0,15,0,15,0,15,0,15,0,15,0}; static c16 w = {15,0,15,0,15,0,15,0,15,0,15,0,15,0,15,0}; check_v16qi (v, w);;
}

void v16qi_vspltish_addself ()
{
  v16qi v = {30,0,30,0,30,0,30,0,30,0,30,0,30,0,30,0}; static c16 w = {30,0,30,0,30,0,30,0,30,0,30,0,30,0,30,0}; check_v16qi (v, w);;
}

void v16qi_vspltish_neg ()
{
  v16qi v = {-5,-1,-5,-1,-5,-1,-5,-1,-5,-1,-5,-1,-5,-1,-5,-1}; static c16 w = {-5,-1,-5,-1,-5,-1,-5,-1,-5,-1,-5,-1,-5,-1,-5,-1}; check_v16qi (v, w);;
}

void v16qi_vspltisw ()
{
  v16qi v = {15,0,0,0,15,0,0,0,15,0,0,0,15,0,0,0}; static c16 w = {15,0,0,0,15,0,0,0,15,0,0,0,15,0,0,0}; check_v16qi (v, w);;
}

void v16qi_vspltisw_addself ()
{
  v16qi v = {30,0,0,0,30,0,0,0,30,0,0,0,30,0,0,0}; static c16 w = {30,0,0,0,30,0,0,0,30,0,0,0,30,0,0,0}; check_v16qi (v, w);;
}

void v16qi_vspltisw_neg ()
{
  v16qi v = {-5,-1,-1,-1,-5,-1,-1,-1,-5,-1,-1,-1,-5,-1,-1,-1}; static c16 w = {-5,-1,-1,-1,-5,-1,-1,-1,-5,-1,-1,-1,-5,-1,-1,-1}; check_v16qi (v, w);;
}
...
void v8hi_vspltisw ()
{
  v8hi v = {15,0,15,0,15,0,15,0}; static s8 w = {15,0,15,0,15,0,15,0}; check_v8hi (v, w);;
}

void v8hi_vspltisw_addself ()
{
  v8hi v = {30,0,30,0,30,0,30,0}; static s8 w = {30,0,30,0,30,0,30,0}; check_v8hi (v, w);;
}

void v8hi_vspltisw_neg ()
{
  v8hi v = {-5,-1,-5,-1,-5,-1,-5,-1}; static s8 w = {-5,-1,-5,-1,-5,-1,-5,-1}; check_v8hi (v, w);;
}
