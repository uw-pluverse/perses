...
void testfunc(char* stack)
{
  ...
  { double __x = d1; ; if (validate_memory (&__x, stack + 336, sizeof (double), flat) != 0) abort(); }
  { double __x = d2; ; if (validate_memory (&__x, stack + 336 +8, sizeof (double), flat) != 0) abort(); }
...
)
{
  ...
  struct z _x0 = _f0;
  struct z _x65535 = _f65535;

  double _x2 = __builtin_va_arg(ap, double);
  double _x3 = __builtin_va_arg(ap, double);
