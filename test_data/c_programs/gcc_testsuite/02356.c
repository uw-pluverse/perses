...
{
  if (ull2f(0ULL) != (float) 0ULL)
    abort();
  if (ull2f(~0ULL) != (float) ~0ULL)
    abort();
  if (ull2f((~0ULL) >> 1) != (float) ((~0ULL) >> 1))
    abort();
  if (ull2f(~((~0ULL) >> 1)) != (float) ~((~0ULL) >> 1))
    abort();

  if (ull2d(0ULL) != (double) 0ULL)
    abort();
  if (ull2d(~0ULL) != (double) ~0ULL)
    abort();
  if (ull2d((~0ULL) >> 1) != (double) ((~0ULL) >> 1))
    abort();
  ...
  if (ull2ld(~0ULL) != (long double) ~0ULL)
    abort();
  if (ull2ld((~0ULL) >> 1) != (long double) ((~0ULL) >> 1))
    abort();
  if (ull2ld(~((~0ULL) >> 1)) != (long double) ~((~0ULL) >> 1))
    abort();

  if (sll2f(0LL) != (float) 0LL)
    abort();
  if (sll2f(~0LL) != (float) ~0LL)
    abort();
  if (! fnear (sll2f((long long int)((~0ULL) >> 1)), (float)(long long int)((~0ULL) >> 1)))
    abort();
  if (sll2f((long long int)(~((~0ULL) >> 1))) != (float)(long long int)~((~0ULL) >> 1))
    abort();

  if (sll2d(0LL) != (double) 0LL)
    abort();
  if (sll2d(~0LL) != (double) ~0LL)
    abort();
  if (!dnear (sll2d((long long int)((~0ULL) >> 1)), (double)(long long int)((~0ULL) >> 1)))
    abort();
  if (! dnear (sll2d((long long int)~((~0ULL) >> 1)), (double)(long long int)~((~0ULL) >> 1)))
    abort();

  if (sll2ld(0LL) != (long double) 0LL)
    abort();
  if (sll2ld(~0LL) != (long double) ~0LL)
    abort();
  if (!ldnear (sll2ld((long long int)((~0ULL) >> 1)), (long double)(long long int)((~0ULL) >> 1)))
    abort();
  if (! ldnear (sll2ld((long long int)~((~0ULL) >> 1)), (long double)(long long int)~((~0ULL) >> 1)))
    abort();
}
...
test_float_to_longlong_integer()
{
  ...
  if (ld2ull(1.99) != 1LL)
    abort();
  if (ld2ull((long double) ((~0ULL) >> 1)) != (~0ULL) >> 1 &&
  ...
  if (f2sll(-1.99) != -1LL)
    abort();
  if (f2sll((float)(long long int)~((~0ULL) >> 1)) != (long long int)~((~0ULL) >> 1))
    abort();
  ...
  if (d2sll(-1.99) != -1LL)
    abort();
  if (d2sll((double)(long long int)~((~0ULL) >> 1)) != (long long int)~((~0ULL) >> 1))
    abort();
  ...
  if (ld2sll(-1.99) != -1LL)
    abort();
  if (ld2sll((long double)(long long int)~((~0ULL) >> 1)) != (long long int)~((~0ULL) >> 1))
    abort();
}
