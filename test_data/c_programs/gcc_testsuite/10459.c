...
fn1 (long int x, long int y, int *ovf)
{
  long int res;
  x &= 65535;
  y = (y & 65535) - (9223372036854775807L / 65535 + 32768);
...
main ()
{
  ...
  if (fn1 (0, 0, &ovf) != 0
      || ovf
      || fn1 (65535, 0, &ovf) != (long int) ((9223372036854775807L / 65535 + 32768UL) * -65535UL)
      || !ovf)
    __builtin_abort ();
  if (fn2 (0, 0, &ovf) != (signed char) (127 / 4 * 4U)
      || ovf
      || fn2 (0, 1, &ovf) != (signed char) (127 / 4 * 5U)
      || !ovf)
    __builtin_abort ();
