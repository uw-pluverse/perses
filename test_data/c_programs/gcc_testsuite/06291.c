...
{
  return __builtin_bswap64(~ __builtin_bswap64(a));
}

uint64_t foo2 (uint64_t a)
{
  return __builtin_bswap64(__builtin_bswap64(a) & 0xA00000000);
}
...
{
  return __builtin_bswap64(__builtin_bswap64(a) & __builtin_bswap64(b));
}
