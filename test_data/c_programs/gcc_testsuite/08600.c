...
void bla1eq (int var)
{
  if (var + 10 == (-2147483647 -1) + 9)
    this_comparison_is_false ();
}

void bla2eq (int var)
{
  if (var + 10 == (-2147483647 -1) + 10)
    this_comparison_is_not_decidable ();
}

void bla3eq (int var)
{
  if (var - 10 == 2147483647 - 9)
    this_comparison_is_false ();
}

void bla4eq (int var)
{
  if (var - 10 == 2147483647 - 10)
    this_comparison_is_not_decidable ();
}
