...
main ()
{
 ...
 r1 = xx / yy;
 r2 = xx % yy;
 if (((r2) >= 0 ? (r2) : -(r2)) >= (unsigned long long) ((yy) >= 0 ? (yy) : -(yy)) || (signed long long) (r1 * yy + r2) != xx)
   abort ();
      }
    save_time:
 ...
 r1 = xx / yy;
 r2 = xx % yy;
 if (((r2) >= 0 ? (r2) : -(r2)) >= (unsigned int) ((yy) >= 0 ? (yy) : -(yy)) || (signed int) (r1 * yy + r2) != xx || ((xx < 0) != (r2 < 0) && r2))
   abort ();
      }
 ...
 r1 = xx / yy;
 r2 = xx % yy;
 if (((r2) >= 0 ? (r2) : -(r2)) >= (unsigned short) ((yy) >= 0 ? (yy) : -(yy)) || (signed short) (r1 * yy + r2) != xx)
   abort ();
      }
 ...
 r1 = xx / yy;
 r2 = xx % yy;
 if (((r2) >= 0 ? (r2) : -(r2)) >= (unsigned char) ((yy) >= 0 ? (yy) : -(yy)) || (signed char) (r1 * yy + r2) != xx)
   abort ();
      }
    }
