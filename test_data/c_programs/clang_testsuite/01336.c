...
__mulxc3(long double __a, long double __b, long double __c, long double __d)
{
    ...
    if (__builtin_isnan((__real__(z))) && __builtin_isnan((__imag__(z))))
    {
        ...
        {
            __a = __builtin_copysignl((__builtin_isinf((__a)) ? 1 : 0), (__a));
            __b = __builtin_copysignl((__builtin_isinf((__b)) ? 1 : 0), (__b));
            if (__builtin_isnan((__c)))
                __c = __builtin_copysignl((0), (__c));
            if (__builtin_isnan((__d)))
                __d = __builtin_copysignl((0), (__d));
            __recalc = 1;
        }
        if (__builtin_isinf((__c)) || __builtin_isinf((__d)))
        {
            __c = __builtin_copysignl((__builtin_isinf((__c)) ? 1 : 0), (__c));
            __d = __builtin_copysignl((__builtin_isinf((__d)) ? 1 : 0), (__d));
            if (__builtin_isnan((__a)))
                __a = __builtin_copysignl((0), (__a));
            if (__builtin_isnan((__b)))
                __b = __builtin_copysignl((0), (__b));
            __recalc = 1;
        }
