...
__lesf2(fp_t a, fp_t b) {
    ...
    const rep_t aAbs = aInt & ((1U << (23 + ((sizeof(rep_t)*8) - 23 - 1))) - 1U);
    const rep_t bAbs = bInt & ((1U << (23 + ((sizeof(rep_t)*8) - 23 - 1))) - 1U);
    if (aAbs > (((1U << (23 + ((sizeof(rep_t)*8) - 23 - 1))) - 1U) ^ ((1U << 23) - 1U)) || bAbs > (((1U << (23 + ((sizeof(rep_t)*8) - 23 - 1))) - 1U) ^ ((1U << 23) - 1U))) return LE_UNORDERED;
...
void __cmpsf2() __attribute__((alias("__lesf2")));
enum GE_RESULT {
    GE_LESS = -1,
    GE_EQUAL = 0,
    GE_GREATER = 1,
...
__gesf2(fp_t a, fp_t b) {
    ...
    const rep_t aAbs = aInt & ((1U << (23 + ((sizeof(rep_t)*8) - 23 - 1))) - 1U);
    const rep_t bAbs = bInt & ((1U << (23 + ((sizeof(rep_t)*8) - 23 - 1))) - 1U);
    if (aAbs > (((1U << (23 + ((sizeof(rep_t)*8) - 23 - 1))) - 1U) ^ ((1U << 23) - 1U)) || bAbs > (((1U << (23 + ((sizeof(rep_t)*8) - 23 - 1))) - 1U) ^ ((1U << 23) - 1U))) return GE_UNORDERED;
...
__unordsf2(fp_t a, fp_t b) {
    ...
    return aAbs > (((1U << (23 + ((sizeof(rep_t)*8) - 23 - 1))) - 1U) ^ ((1U << 23) - 1U)) || bAbs > (((1U << (23 + ((sizeof(rep_t)*8) - 23 - 1))) - 1U) ^ ((1U << 23) - 1U));
}
 enum LE_RESULT
