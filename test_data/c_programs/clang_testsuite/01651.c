...
void wsr64_2(unsigned long v) {
  __builtin_arm_wsr64("cp0:1:c2:c3:4", v);
}
unsigned rsr_2() {
...
unsigned long rsr64_2() {
  return __builtin_arm_rsr64("cp0:1:c2:c3:4");
}
void wsr_3(unsigned v) {
  __builtin_arm_wsr("cp0:1:c2", v);
}
void wsrp_3(void *v) {
  __builtin_arm_wsrp("cp0:1:c2", v);
}
void wsr64_3(unsigned long v) {
  __builtin_arm_wsr64("cp0:1:c2", v);
}
unsigned rsr_3() {
  return __builtin_arm_rsr("cp0:1:c2");
}
void *rsrp_3() {
  return __builtin_arm_rsrp("cp0:1:c2");
}
...
unsigned rsr_5() {
  return __builtin_arm_rsr("cp0:1:c2:c3:8");
}
unsigned rsr_6() {
  return __builtin_arm_rsr("cp0:8:c1:c2:3");
}
unsigned rsr_7() {
  return __builtin_arm_rsr("cp0:1:c16:c16:2");
}
void *rsrp_4() {
...
unsigned long rsr64_5() {
  return __builtin_arm_rsr64("cp0:8:c1");
}
unsigned long rsr64_6() {
  return __builtin_arm_rsr64("cp0:1:c16");
}
