...
__negvsi2(si_int a)
{
    const si_int MIN = (si_int)1 << ((int)(sizeof(si_int) * 8)-1);
    if (a == MIN)
        compilerrt_abort_impl("/tmp/llvm-builder/llvm-source-trunk/projects/compiler-rt/lib/builtins/negvsi2.c", 26, __func__);
    return -a;
}
