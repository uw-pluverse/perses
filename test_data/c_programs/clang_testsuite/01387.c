...
static __inline fp_t __addXf3__(fp_t a, fp_t b) {
    rep_t aRep = toRep(a);
    rep_t bRep = toRep(b);
    const rep_t aAbs = aRep & ((1UL << (52 + ((sizeof(rep_t)*8) - 52 - 1))) - 1U);
    const rep_t bAbs = bRep & ((1UL << (52 + ((sizeof(rep_t)*8) - 52 - 1))) - 1U);
    if (aAbs - 1UL >= (((1UL << (52 + ((sizeof(rep_t)*8) - 52 - 1))) - 1U) ^ ((1UL << 52) - 1U)) - 1UL ||
        bAbs - 1UL >= (((1UL << (52 + ((sizeof(rep_t)*8) - 52 - 1))) - 1U) ^ ((1UL << 52) - 1U)) - 1UL) {
        ...
        if (aAbs == (((1UL << (52 + ((sizeof(rep_t)*8) - 52 - 1))) - 1U) ^ ((1UL << 52) - 1U))) {
            if ((toRep(a) ^ toRep(b)) == (1UL << (52 + ((sizeof(rep_t)*8) - 52 - 1)))) return fromRep(((((1UL << (52 + ((sizeof(rep_t)*8) - 52 - 1))) - 1U) ^ ((1UL << 52) - 1U)) | ((1UL << 52) >> 1)));
            else return a;
        }
        if (bAbs == (((1UL << (52 + ((sizeof(rep_t)*8) - 52 - 1))) - 1U) ^ ((1UL << 52) - 1U))) return b;
        if (!aAbs) {
    ...
    const rep_t resultSign = aRep & (1UL << (52 + ((sizeof(rep_t)*8) - 52 - 1)));
    const _Bool subtraction = (aRep ^ bRep) & (1UL << (52 + ((sizeof(rep_t)*8) - 52 - 1)));
    ...
    if (aExponent >= ((1 << ((sizeof(rep_t)*8) - 52 - 1)) - 1)) return fromRep((((1UL << (52 + ((sizeof(rep_t)*8) - 52 - 1))) - 1U) ^ ((1UL << 52) - 1U)) | resultSign);
    if (aExponent <= 0) {
