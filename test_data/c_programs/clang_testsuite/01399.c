...
__subvdi3(di_int a, di_int b)
{
    ...
    {
        if (s > a)
            compilerrt_abort_impl("/tmp/llvm-builder/llvm-source-trunk/projects/compiler-rt/lib/builtins/subvdi3.c", 28, __func__);
    }
    else
    {
        if (s <= a)
            compilerrt_abort_impl("/tmp/llvm-builder/llvm-source-trunk/projects/compiler-rt/lib/builtins/subvdi3.c", 33, __func__);
    }
    return s;
}
