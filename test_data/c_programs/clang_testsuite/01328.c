...
__addvti3(ti_int a, ti_int b)
{
    ...
    {
        if (s < a)
            compilerrt_abort_impl("/tmp/llvm-builder/llvm-source-trunk/projects/compiler-rt/lib/builtins/addvti3.c", 30, __func__);
    }
    else
    {
        if (s >= a)
            compilerrt_abort_impl("/tmp/llvm-builder/llvm-source-trunk/projects/compiler-rt/lib/builtins/addvti3.c", 35, __func__);
    }
    return s;
}
