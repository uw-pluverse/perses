...
__negvdi2(di_int a)
{
    const di_int MIN = (di_int)1 << ((int)(sizeof(di_int) * 8)-1);
    if (a == MIN)
        compilerrt_abort_impl("/tmp/llvm-builder/llvm-source-trunk/projects/compiler-rt/lib/builtins/negvdi2.c", 26, __func__);
    return -a;
}
