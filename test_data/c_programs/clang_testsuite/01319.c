...
__attribute__((noreturn)) void compilerrt_abort_impl(const char *file, int line,
 ...
 du_int __dtou64(double a) { return __fixunsdfdi(a); }
 du_int __stou64(float a) { return __fixunssfdi(a); }
 double __i64tod(di_int a) { return __floatdidf(a); }
 float __i64tos(di_int a) { return __floatdisf(a); }
 double __u64tod(du_int a) { return __floatundidf(a); }
 float __u64tos(du_int a) { return __floatundisf(a); }
