...
void wsr_3(unsigned v) {
  __builtin_arm_wsr("0:1:2", v);
}
void wsrp_3(void *v) {
  __builtin_arm_wsrp("0:1:2", v);
}
void wsr64_3(unsigned long v) {
  __builtin_arm_wsr64("0:1:2", v);
}
unsigned rsr_3() {
  return __builtin_arm_rsr("0:1:2");
}
unsigned rsr_4() {
  return __builtin_arm_rsr("0:1:2:3:8");
}
unsigned rsr_5() {
  return __builtin_arm_rsr("0:8:1:2:3");
}
unsigned rsr_6() {
  return __builtin_arm_rsr("0:1:16:16:2");
}
void *rsrp_3() {
  return __builtin_arm_rsrp("0:1:2");
}
unsigned long rsr64_3() {
  return __builtin_arm_rsr64("0:1:2");
}
unsigned long rsr64_4() {
  return __builtin_arm_rsr64("0:1:2:3:8");
}
unsigned long rsr64_5() {
  return __builtin_arm_rsr64("0:8:2:3:4");
}
unsigned long rsr64_6() {
  return __builtin_arm_rsr64("0:1:16:16:2");
}
