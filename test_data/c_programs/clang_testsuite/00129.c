...
int bool_lock_free = 2;
int char_lock_free = 2;
int char16_t_lock_free = 2;
int char32_t_lock_free = 2;
int wchar_t_lock_free = 2;
int short_lock_free = 2;
int int_lock_free = 2;
int long_lock_free = 2;
int llong_lock_free = 2;
int pointer_lock_free = 2;
