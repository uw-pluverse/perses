...
static int a0[(sizeof (struct_0) == 1) -1];
static int a1[(sizeof (struct_1) == 4) -1];
static int a2[(sizeof (struct_2) == 24) -1];
static int a3[(sizeof (struct_3) == 8) -1];
static int a4[(sizeof (struct_4) == 32) -1];
static int a5[(sizeof (struct_5) == 12) -1];
static int a6[(sizeof (struct_6) == 40) -1];
static int a7[(sizeof (struct_7) == 8) -1];
static int a8[(sizeof (struct_8) == 20) -1];
static int a9[(sizeof (struct_9) == 32) -1];
