...
public class TestDefaultMethodsSyntax {
    ...
    enum ModifierKind {
        ...
        static Result[][] allowedModifierPairs = {
                       ...
                       { T   , T    , C        , C       , T       , T     , C     , C           , C    , C       , I   },
                     { T   , F    , F        , F       , T       , T     , C     , C           , C    , C       , I   },
                  { C   , F    , F        , F       , C       , C     , C     , C           , C    , C       , F   },
                    { C   , F    , F        , F       , F       , C     , C     , C           , C    , C       , F   },
                   { T   , T    , C        , F       , F       , F     , F     , F           , F    , F       , F   },
                     { T   , T    , C        , C       , F       , F     , C     , C           , C    , T       , F   },
                     { C   , C    , C        , C       , F       , C     , F     , C           , C    , F       , F   },
               { C   , C    , C        , C       , F       , C     , C     , F           , C    , C       , F   },
                      { C   , C    , C        , C       , F       , C     , C     , C           , F    , C       , F   },
                   { C   , C    , C        , C       , F       , T     , F     , C           , C    , F       , I   },
                    { I   , I    , F        , F       , F       , F     , F     , F           , F    , I       , F   }};
    }
